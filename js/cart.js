    ...
    let y=products.map((item) => {
      let totalItemPrice=item.price*item.quantity
       ...
       totalPrice +=totalItemPrice
        return `
        <div class="card mb-3 col-md-4 col-12 cart-parent" style="max-width:30%; padding:5px">
        <div class="row g-0">
          <div class="col-md-4">
...
function    drawCartFav(allproducts=[]){
  let products=JSON.parse( localStorage.getItem("ProductsFav"))||allproducts
    let x=products.map((item) => {
        ...
        <div class="card mb-3 col-md-3 me-1 col-sm-12" style="max-width:30%; padding:5px">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="${item.imageUrl}" class="img-fluid rounded-start" style="margin-top:5px; height:130px"alt="...">
          </div>
